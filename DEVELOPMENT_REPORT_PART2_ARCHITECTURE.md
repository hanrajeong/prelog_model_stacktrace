...
│                                                                 │
│  룰 예시:                                                       │
│  • "at null" → NullPointerException (100%)                     │
│  • "divide by zero" → ArithmeticException (100%)               │
│  • "Index X out of bounds" → ArrayIndexOutOfBoundsException    │
│  • "ORA-00001" → SQLException (Oracle 중복 키)                 │
└─────────────────────────────────────────────────────────────────┘
                              ↓
                   ┌──────────────────┐
                   │  룰 매칭 성공?   │
